var MODIS_Phen = ee.ImageCollection("MODIS/006/MCD12Q2");
...
Export.table.toDrive({
  ...
  description: 'Senescence_BioControlDatabase_RAIF_2001_2018_on_pixel',
  fileFormat:'CSV',
...
Export.table.toDrive({
  collection:greenup_1__time_series,
  description: 'Senescence_BioControlDatabase_RAIF_2001_2018_' + m,
  fileFormat:'CSV',
  folder: GDriveOutputImgFolder
})
