...
var GDriveOutputImgFolder = 'GEEOUTPUTS/Landsat7_NDVI'; 
 
//***********************************************ON PIXEL***************************
for (var i = 1997; i < 2019; i++){
//for (var i = 1997; i < 1998; i++){
...
//https://www.w3schools.com/js/js_if_else.asp 
  ...
  //print(EVI_std);
var  Fpar_500m_min = (Fpar_500m1.reduce(ee.Reducer.minMax()))
print('Fpar_500m_min',Fpar_500m_min)
...
Export.table.toDrive({
  ...
  description: 'Landsat7_NDVI_current_year_on_pixel',
  fileFormat:'CSV',
...
Export.table.toDrive({
  ...
  description: 'Landsat7_NDVI_current_year_buffer_'+ m,
  fileFormat:'CSV',
  folder: GDriveOutputImgFolder
}) 
