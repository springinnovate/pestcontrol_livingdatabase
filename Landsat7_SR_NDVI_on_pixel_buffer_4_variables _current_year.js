...
function calcIndex(image){
  var evi = image.expression(
   ...
   return image.addBands((evi.rename('NDVI')).multiply(10000).int16());
...
Export.table.toDrive({
  ...
  description: 'Landsat7_NDVI_SR_current_year_on_pixel',
  fileFormat:'CSV',
...
Export.table.toDrive({
  ...
  description: 'Landsat7_NDVI_SR_current_year_buffer_'+ m,
  fileFormat:'CSV',
  folder: GDriveOutputImgFolder
}) 
